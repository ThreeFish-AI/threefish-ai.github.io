...
$$
    \frac{\partial}{\partial x}[f(x, y)] = \frac{\partial g(x)}{\partial x} \pm \frac{\partial h(y)}{\partial x} = g'(x)
$$

$$
    \frac{\partial}{\partial y}[f(x, y)] = \frac{\partial g(x)}{\partial y} \pm \frac{\partial h(y)}{\partial y} = h'(y)
$$
