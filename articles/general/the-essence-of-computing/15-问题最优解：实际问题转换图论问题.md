---
id: graph-practical-problem
sidebar_position: 15
title: 问题最优解：实际问题转换图论问题
description: 问题最优解：实际问题转换图论问题
last_update:
  author: Aurelius
  date: 2024-08-30
tags:
...
![Cover](assets/问题最优解：实际问题转换图论问题.drawio.png)
...
我们可以使用 `NetworkX` 和 `Scikit-learn` 库来完成这一分析：
...
```
tensor([[-0.7057, -1.3313],
        [-1.0062, -1.9482],
        [-0.9465, -1.8678]], grad_fn=<AddBackward0>)
```
...
```python
# before: brew install graph-tool
...
![Social Network Graph](<assets/graph-theory/Social Network Graph.png>)
